...
int main(int argc, char** argv) //--- 윈도우 출력하고 콜백함수 설정
{
	...
	// x: -3~3, y: 0~18, z: -3~3
	Cube cube5(
		glm::vec3(-3.0f, 0.0f, -3.0f), // v0: 앞면왬쪽 아래
...
GLvoid drawScene() //--- 콜백 함수: 그리기 콜백 함수
{
	...
	glm::vec3 viewPos = cameraPos;                       // 카메라 위치
	glm::vec3 lightColor = lightColors[currentLightColorIndex]; // 배열에서 현재 조명 색상 가져오기
	glm::vec3 objectColor(1.0f, 1.0f, 1.0f);            // 흰색 객체 (기본값)
	...
	if (!allVertices.empty()) {
		...
		objectColor = glm::vec3(180.0f / 255.0f, 180.0f / 255.0f, 180.0f / 255.0f);
		glUniform3fv(objectColorLocation, 1, glm::value_ptr(objectColor));
		...
		objectColor = glm::vec3(255.0f / 255.0f, 0.0f / 255.0f, 255.0f / 255.0f);
		glUniform3fv(objectColorLocation, 1, glm::value_ptr(objectColor));
		// 탱크 좌표
		...
		objectColor = glm::vec3(0.0f / 255.0f, 255.0f / 255.0f, 0.0f / 255.0f);
		glUniform3fv(objectColorLocation, 1, glm::value_ptr(objectColor));
		...
		objectColor = glm::vec3(255.0f / 255.0f, 255.0f / 255.0f, 0.0f / 255.0f);
		glUniform3fv(objectColorLocation, 1, glm::value_ptr(objectColor));
		...
		objectColor = glm::vec3(180.0f / 255.0f, 180.0f / 255.0f, 0.0f / 255.0f);
		glUniform3fv(objectColorLocation, 1, glm::value_ptr(objectColor));
